							...
							<div className="overflow-hidden shadow-sm bg-base-100 rounded-xl">
								...
								<div className="px-4 py-3 border-b border-base-300 bg-base-100">
									<div className="flex items-center gap-3">
										<div className="flex items-center justify-center w-8 h-8 font-medium rounded-full bg-primary text-primary-content">J</div>
										<div>
                          ...
                          `}>
								...
								<div className="p-4 border-t border-base-300 bg-base-100">
									<div className="flex gap-2">
										<input type="text" className="flex-1 h-10 text-sm input input-bordered" placeholder="Type a message..." value="This is a preview" readOnly />
